...
<p align="center">
  <img src="design/avatar-500.png" width="140" alt="筷点小程序图标">
</p>
...
> **筷点**（kuài diǎn）—— 「筷」是吃饭的家伙，「点」就是点菜这个动作；合起来还谐音「快点，开饭！」。
...
**筷点**把"随便"变成"投票"。掌勺人（通常是家里做饭的人）把会做的菜录入家庭菜谱；其他家庭成员每天打开小程序，为想吃的菜点一票；票数实时汇总，掌勺人照单做菜，谁也没意见。
